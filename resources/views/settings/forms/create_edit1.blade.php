    ...
    <div class="row" style="margin-top:0">
        <div class="col-md-12 ">
            <div class="card bg-light">
                <div class="card-body col-sm-10 col-md-10" style="min-height:550px;">
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="input-group input-group-lg">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-lg">Form Title</span>
                                        </div>
                                    ...
                                    <div class="input-group input-group-lg">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-lg1">Description</span>
                                        </div>
                                            <input type="text" id="formTitle" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm1">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body" id="dropdownElsList">
                                </div>
                            </div>
                        </div>
                        <!-- Add a Fields Block -->
