...
<form method="post" action="{{ route('insights.store') }}" name="create_resources_form" id="create_resources_form" enctype="multipart/form-data">
                               ...
                               <div class="tab-pane container" id="url">
                                 ...
                                 <div class="form-group">
											<div>
												...
												<a href="{{ URL::asset('insights/manage')}}" type="reset" class="btn btn-secondary waves-effect m-l-5">Cancel</a>
											</div>
							      </div>
