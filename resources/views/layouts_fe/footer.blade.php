<footer class="ftco-footer ftco-section">
  ...
  <script src="{{ URL:: asset('assets/fe/js/jquery.easing.1.3.js')}}"></script>
  <script src="{{ URL:: asset('assets/fe/js/jquery.waypoints.min.js')}}"></script>
  <script src="{{ URL:: asset('assets/fe/js/jquery.stellar.min.js')}}"></script>
  <script src="{{ URL:: asset('assets/fe/js/owl.carousel.min.js')}}"></script>
  <script src="{{ URL:: asset('assets/fe/js/jquery.magnific-popup.min.js')}}"></script>
  <script src="{{ URL:: asset('assets/fe/js/aos.js')}}"></script>
  <script src="{{ URL:: asset('assets/fe/js/jquery.animateNumber.min.js')}}"></script>
  <script src="{{ URL:: asset('assets/fe/js/scrollax.min.js')}}"></script>
